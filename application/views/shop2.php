...
<div class="theme-layout">
									...
									<div class="row">
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="about">Digital Market</a>
										...
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												...
												<li>
													<a class="active" href="shop2">Market Place</a>
												</li>
												<li>
													<a class="" href="shop-cart">Cart</a>
												</li>
												<li>
													<a class="" href="shop-checkout">Checkout</a>
												</li>
												<li>
													<a class="" href="shop-detail">Prod Detail</a>
												</li>
												<li>
													<div class="more">
														...
														<ul class="more-dropdown">
															<li>
																<a href="timeline-friends2">Followers</a>
															</li>
															<li>
																<a href="timeline-photos">Photos</a>
															</li>
														</ul>
													</div>
												</li>
											...
											<div>
												...
												<div class="form-radio">
												  ...
												  <div class="radio">
													...
													<div class="radio">
													<label>
													  <input type="radio" name="radio"><i class="check-box"></i>php Template
													</label>
												  </div>
													<div class="radio">
													<label>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<div class="dig-pro">
												...
												<div class="digi-meta">
													<h4><a href="product-detail" title="">EMail Marketing 2020</a></h4>
										...
										<div class="col-lg-6 col-md-6">
											<div class="dig-pro">
												...
												<div class="digi-meta">
													<h4><a href="product-detail" title="">Android studio app</a></h4>
	...
	<script src="<?php echo base_url(''); ?>/public/js/userincr.js"></script><!-- Increment prodcut button-->
