									...
									<div class="row">
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="Controllerabout">Digital Market</a>
										...
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												<li>
													<a class="" href="Controllershop">Shop</a>
												</li>
												<li>
													<a class="active" href="shop2">Market Place</a>
												</li>
												<li>
													<a class="" href="Controllershopcart">Cart</a>
												</li>
												<li>
												...
												<li>
													<div class="more">
														...
														<ul class="more-dropdown">
															<li>
																<a href="Controllertimelinefriends2">Followers</a>
															</li>
															<li>
																<a href="Controllertimelinephotos">Photos</a>
															</li>
														</ul>
													</div>
												</li>
