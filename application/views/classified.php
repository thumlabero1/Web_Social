									...
									<div class="row">
										<div class="col-lg-2">
											<div class="profile-author">
												<a class="profile-author-thumb" href="02-ProfilePage">
													<img alt="author" src="images/resources/classified-dp.jpg">
												</a>
												<div class="author-content">
													<a class="h4 author-name" href="02-ProfilePage">Buy & Sell</a>
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												<li>
													<a class="" href="02-ProfilePage">Timeline</a>
												</li>
												<li>
													<a href="05-ProfilePage-About">About</a>
												</li>
												<li>
													<a href="06-ProfilePage">Friends</a>
												</li>
												<li>
													<a href="07-ProfilePage-Photos">Photos</a>
												</li>
												<li>
													<a href="09-ProfilePage-Videos">Videos</a>
												</li>
												<li>
													<div class="more">
								...
								<aside class="sidebar static left">
									<div class="widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="105f7375717e4f7d7f64757c50697f65627d71797c3e737f7d">[email&#160;protected]</a></li>
										</ul>
									</div><!-- Page Community-->
									<div class="widget">
									...
									<div class="widget">
										...
										<div class="your-page">
											...
											<div class="page-meta">
												...
												<span><i class="ti-comment"></i><a href="insight" title="">Messages <em class="bg-blue">9</em></a></span>
												<span><i class="ti-bell"></i><a href="insight" title="">Notifications <em class="bg-purple">2</em></a></span>
											</div>
