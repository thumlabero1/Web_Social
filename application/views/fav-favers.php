										...
										<li>
											<div class="edit-seting" title="Edit Profile image" data-toggle="tooltip"><i class="fa fa-sliders"></i>
												<ul class="more-dropdown">
													...
													<li>
														<a href="Controllersupportandhelp" title="">Find support</a>
													</li>
													<li>
									...
									<div class="row">
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												<li>
													<a class="" href="Controllerfavpage">Page Feed</a>
												</li>
												<li>
													<a class="active" href="Controllerfavfavers">Followers</a>
												</li>
												<li>
													<a class="" href="Controllerfavevents">Events</a>
												</li>
												<li>
													<a class="" href="Controllerfaveventinvitations">Invitations</a>
												</li>
												<li>
													<a class="" href="Controllereventcalendar">Calender</a>
												</li>
												<li>
													<a href="Controllerfavpagecreate" title="Create New Page"><i class="fa fa-plus-circle"></i></a>
												</li>
											</ul>
								...
								<aside class="sidebar static left">
									...
									<div class="widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="450a2620242b1a282a312029053c2a303728242c296b262a28">[email&#160;protected]</a></li>
										</ul>
									</div><!-- Page Community-->		
								</aside>
							</div><!-- sidebar -->
