									...
									<div class="row">
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												...
												<li>
													<a class="active" href="Controllerfaveventinvitations">Invitations</a>
												</li>
												<li>
								...
								<aside class="sidebar static left">
									...
									<div class="widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d699b5b3b7b889bbb9a2b3ba96afb9a3a4bbb7bfbaf8b5b9bb">[email&#160;protected]</a></li>
										</ul>
									</div><!-- Page Community-->
								</aside>
							</div><!-- sidebar -->
