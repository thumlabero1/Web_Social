									...
									<div class="row">
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												<li>
													<a class="active" href="fav-page">Page Feed</a>
												</li>
												<li>
													<a class="" href="fav-favers">Followers</a>
												</li>
												<li>
													<a class="" href="fav-events">Events</a>
												</li>
												<li>
													<a class="" href="fav-event-invitations">Invitations</a>
												</li>
												<li>
													<a class="" href="event-calendar">Calender</a>
												</li>
												<li>
													<a href="fav-page-create" title="Create New Page"><i class="fa fa-plus-circle"></i></a>
												</li>
											</ul>
